/*****************************************************************
reflectingCube:  reflection map of a colored cube onto another cube rotating inside of it,similar to relectionMap but lets the user rotate the object instead of appearing to rotate the texture cube.
纹理坐标四立方体6个面（每个面单一颜色纹理，各面不同颜色）围成的，
镜面表面多边形也是立方体，在纹理立方体内。
...
function configureCubeMap() {
    ...
    gl.texImage2D(gl.TEXTURE_CUBE_MAP_NEGATIVE_Y ,0,gl.RGBA,1,1,0,gl.RGBA,gl.UNSIGNED_BYTE, cyan);//青
    ...
    gl.texImage2D(gl.TEXTURE_CUBE_MAP_POSITIVE_Z ,0,gl.RGBA,1,1,0,gl.RGBA,gl.UNSIGNED_BYTE, yellow);//调整位置
