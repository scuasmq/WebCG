/***********************************************************************
reflectingSphere:  reflection map of a sphere inside a cube.,similar to relectionMap2 but lets the user rotate the object instead of appearing to rotate the texture cube.
纹理坐标四立方体6个面（每个面单一颜色纹理，各面不同颜色）围成的，
镜面表面是球面，在纹理立方体内。有光源 WC下：var lightPosition = vec4(1.0, 1.0, 1.0, 0.0 );
界面参数改变可动的视点位置，以及球面递归生成的细分次数，可观察到物体表面贴图的变化。
